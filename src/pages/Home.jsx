...
const HomePageDesktop = () => {
    ...
    return (
        ...
        // </div>
        <div className="hidden md:grid grid-cols-8 grid-rows-5 w-full max-h-screen h-fit overflow-hidden container mx-auto z-[1]">
            ...
            <div className="flex justify-center items-center col-start-6 col-end-8 row-start-2 row-end-4 z-[2]">
                <img src={blueBubble} alt="" />
            </div>
            <div className="flex justify-center items-center scale-50 col-start-1 col-end-3 row-start-4 row-end-6 z-[2]">
                <img src={blueBubble} alt="" />
            </div>
            <div className="flex justify-center items-center col-start-3 col-end-5 row-start-1 row-end-3 z-[2]">
                <img src={redBubble} alt="" />
            </div>
            <div className="flex justify-center items-center scale-50 col-start-7 col-end-9 row-start-1 row-end-3 z-[2]">
                <img src={redBubble} alt="" />
            </div>
            <div className="flex justify-center items-center scale-75 col-start-5 col-end-7 row-start-4 row-end-6 z-[2]">
                <img src={redBubble} alt="" />
            </div>
            ...
            <div className="items-center justify-center col-start-3 col-end-7 row-start-2 row-end-5 grid grid-cols-8 grid-rows-6 z-[1]">
                ...
                <img src={logo} alt="logo" className="max-h-32 col-start-2 col-end-4 row-start-3 row-end-4 translate-x-[50%] z-[2]" />
            </div>
        </div>
    );
};
