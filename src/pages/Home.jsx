...
const HomePageDesktop = () => {
    ...
    return (
        ...
        <div className="hidden md:grid grid-cols-8 grid-rows-5 w-full max-h-screen h-fit overflow-hidden container mx-auto">
            ...
            <div className='aspect-square col-start-1 col-end-4 row-start-1 row-end-2 grid grid-cols-6 grid-rows-6 z-40'>
            ...
            <div className='aspect-square col-start-6 col-end-9 row-start-3 row-end-6 grid grid-cols-6 grid-rows-6 bg/50'>
                ...
                <img src={pen} alt="" className='z-40 col-start-5 col-end-6 row-start-2 row-end-4 -translate-x-8 translate-y-8' />
            </div>
            <div className="flex justify-center items-center col-start-2 col-end-4 row-start-2 row-end-4 z-40">
                <img src={blueBubble} alt="" />
            </div>
            <div className="flex justify-center items-center col-start-6 col-end-8 row-start-2 row-end-4 z-40">
                <img src={blueBubble} alt="" />
            </div>
            <div className="flex justify-center items-center scale-50 col-start-1 col-end-3 row-start-4 row-end-6 z-40">
                <img src={blueBubble} alt="" />
            </div>
            <div className="flex justify-center items-center col-start-3 col-end-5 row-start-1 row-end-3 z-40">
                <img src={redBubble} alt="" />
            </div>
            <div className="flex justify-center items-center scale-50 col-start-7 col-end-9 row-start-1 row-end-3 z-40">
                <img src={redBubble} alt="" />
            </div>
            <div className="flex justify-center items-center scale-75 col-start-5 col-end-7 row-start-4 row-end-6 z-40">
                <img src={redBubble} alt="" />
            </div>
            ...
            <div className="items-center justify-center col-start-3 col-end-7 row-start-2 row-end-5 grid grid-cols-8 grid-rows-6">
                ...
                <div className="max-h-full rounded-full aspect-square shadow-2xl col-start-2 col-end-9 row-start-1 row-end-7 flex justify-center items-end overflow-hidden -z-40 bg-gradient-to-bl from-[hsla(177,47%,50%,.3)] via-[hsla(201,89%,21%,.3)] via-[hsla(194,38%,18%,.3)] via-[hsla(348,31%,34%,.3)] to-[hsla(355,78%,58%,.3)] ">
                    <img src={perso} alt="" className="h-[75%] translate-y-2 aspect-square" />
                </div>
                <img src={logo} alt="logo" className="max-h-32 col-start-2 col-end-4 row-start-3 row-end-4 translate-x-[115%] -z-10 absolute" />
            </div>
...
const HomePageMobile = () => {
    return(
        <div className="w-screen h-screen max-w-full max-h-full grid grid-rows-6 grid-cols-8 md:hidden overflow-hidden">
            <div className="row-start-1 row-end-5 col-start-1 col-end-9 rounded-b-full -translate-y-8 bg-gradient-to-bl from-[hsla(177,47%,50%,.3)] via-[hsla(201,89%,21%,.3)] via-[hsla(194,38%,18%,.3)] via-[hsla(348,31%,34%,.3)] to-[hsla(355,78%,58%,.3)] -z-50"></div>
