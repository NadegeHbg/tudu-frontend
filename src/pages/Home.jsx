    ...
    return (
        ...
        <div className="hidden md:grid grid-cols-8 grid-rows-5 w-full max-h-screen h-fit overflow-hidden container mx-auto">
            ...
            <div className="items-center justify-center col-start-3 col-end-7 row-start-2 row-end-5 grid grid-cols-8 grid-rows-6">
                ...
                <div className="max-h-full rounded-full aspect-square shadow-2xl col-start-2 col-end-9 row-start-1 row-end-7 flex justify-center items-end overflow-hidden -z-10 bg-gradient-to-bl from-[hsla(177,47%,50%,.3)] via-[hsla(201,89%,21%,.3)] via-[hsla(194,38%,18%,.3)] via-[hsla(348,31%,34%,.3)] to-[hsla(355,78%,58%,.3)] -z-50 ">
